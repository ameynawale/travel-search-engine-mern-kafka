...
class UserProfile extends React.Component{
    ...
    state= {
        userProfile: [
            {
                userId: this.props.userRequested.user,
                firstName: this.props.userRequested.firstName,
                lastName: this.props.userRequested.lastName,
                city: this.props.userRequested.city,
                state: this.props.userRequested.state,
                zipCode: this.props.userRequested.zipCode,
                phoneNumber: this.props.userRequested.phoneNumber,
                email: this.props.userRequested.email,
                tripId: this.props.userRequested.tripId,
                creditCardDetails: this.props.userRequested.creditCardDetails
            },
                        ...
                        <div className="row justify-content-md-center">
                            ...
                            <div className="col-md-5">
                                ...
                                <form>
                                      ...
                                      <h4>User Id:</h4>
                                      <h4> <input type="number"  className="form-control" defaultValue={this.state.userId} /></h4>
