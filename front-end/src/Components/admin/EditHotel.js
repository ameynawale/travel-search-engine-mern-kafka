...
class EditHotel extends Component {
    ...
    static propTypes = {
        hotelDetails: PropTypes.string.hotelDetails,
                            ...
                            <div className="col-md-8">
                                ...
                                <form>
                                    <div className="form-group">
                                        <h4><strong>EDIT HOTEL</strong></h4>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <div className="form-group col-md-6">
                                            <input
                                                ...
                                                placeholder={this.state.availableRooms}
                                    ...
                                    <div>
                                        <div display="block" className="col-md-6">
                                            <label style={{float:'right'}}>Guest Count:</label>
                                        </div>
                                        <div className="form-group col-md-6">
                                            <input
                                                className="form-control"
                                    ...
                                    <div>
                                        <div display="block" className="col-md-6">
                                            <label style={{float:'right'}}>Stars:</label>
                                        </div>
                                        <div className="form-group col-md-6">
                                            <input
                                                className="form-control"
                                                type="text"
                                                label="starHotel"
                                                placeholder={this.state.starHotel}
                                                value={this.state.starHotel}
                                                onChange={(event) => {
                                                    this.setState({
                                                        starHotel: event.target.value
                                                    });
                                                }}
                                            />
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="form-group col-md-6">
                                            <input
                                                ...
                                                type="text"
                                                label="ratings"
                                                placeholder={this.state.ratings}
                                    ...
                                    <div>
                                        ...
                                        <div className="form-group col-md-6">
                                            <input
                                                ...
                                                type="text"
                                                label="bookedRooms"
                                                placeholder={this.state.bookedRooms}
                                                value={this.state.bookedRooms}
                                                onChange={(event) => {
                                                    this.setState({
                                                        bookedRooms: event.target.value
                                                    });
                                                }}
                                            />
                                        </div>
