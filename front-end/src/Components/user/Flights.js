                                    ...
                                    <div className="col-xs-6 col-sm-offset-3">
                                        ...
                                        <div className="dashboard">
                                            ...
                                            <input type="text"
                                                   ...
                                                   style={{marginLeft: "5px", width:"180px", marginTop: "35px"}}
                                            ...
                                            <input type="text"
                                                   ...
                                                   className="formFields1"
                                                   style={{ width:"180px"}}
                                                   onChange={e => this.setState({ passengerCount: e.target.value })}
                                            />
                                            <input type="Dropdown"
                                                   className="dropdown-menu formFields"
                                            ...
                                            <button className="searchbtn btn-search"
                                                    type="button"
                                                    onClick={() => this.props.searchFlight(this.state)}
                                            >
                                                <h3> <b>--></b> </h3>
                                            </button>
