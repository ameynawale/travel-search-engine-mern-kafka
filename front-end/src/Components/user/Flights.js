                                    ...
                                    <div className="navWide">
                                        <div className="wideDiv">
                                            ...
                                            <a className= "Flights text-white" onClick={() => {
                                                this.props.history.push("/Flights")}}> <h4>Flights</h4> </a>
                                ...
                                <div className="mainform">
                                    ...
                                    <div className="col-xs-6 col-sm-offset-3">
                                        ...
                                        <div className="dashboard">
                                            ...
                                            <input type="text" placeholder="origin" className="formFields" style={{marginLeft: "5px", width:"180px", marginTop: "35px"}} onChange={e => this.setState({ origin: e.target.value })}/>
                                            ...
                                            <input type="date" className="formFields" style={{ width:"180px"}} onChange={e => this.setState({ travelDate: e.target.value })} />
                                                <input type="Dropdown" className="dropdown-menu" style={{height:"10px", width:"180px"}}/>

                                                 <select id = "travelClass">
                                                     <input type="text" placeholder="Class" className="formFields1" style={{"height":"55px", width:"180px"}} onChange={e => this.setState({ travelClass: e.target.value })}/>
                                                <option value = "Economy">Economy</option>
                                            <option value = "Buisness">Buisness</option>
                                              </select>


                                            <button className="searchbtn btn-search" type="button" onClick={() => this.props.getSearchResult(this.state)}>
                                                <h3> <b>--></b> </h3>
                                            </button>
                                            ...
                                            {/*<img src={require('./enter.png')} alt="enter" className= "enterImage"style={{"height":"55px", "width":"55px"}}/>*/}
                                        </div>
