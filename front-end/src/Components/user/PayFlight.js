...
class PayFlight extends React.Component{
    ...
    constructor(props){
        ...
        this.state={
            ...
            billAmount: this.props.flightDetails.bill_amount,

            fromCity: this.props.flightRequested.fromCity,
            toCity: this.props.flightRequested.toCity,
            departureDate: this.props.flightRequested.departureDate,
            returnDate: this.props.flightRequested.returnDate,
            seatType: this.props.flightRequested.seatType,
